...
(function() {
  'use strict';
  var Grid, directions, getArrowImage, getArrowImages, mouseMove;
  ...
  Grid.prototype._setupHitRegions = function() {
    var dir, getCellRegion, i, j, offset, _i, _j, _k, _len, _ref, _ref1;
    ...
    for (i = _i = 0, _ref = this.playfield.width; 0 <= _ref ? _i < _ref : _i > _ref; i = 0 <= _ref ? ++_i : --_i) {
      for (j = _j = 0, _ref1 = this.playfield.height; 0 <= _ref1 ? _j < _ref1 : _j > _ref1; j = 0 <= _ref1 ? ++_j : --_j) {
        for (_k = 0, _len = directions.length; _k < _len; _k++) {
          dir = directions[_k];
          if (this.pathSet.has(i, j, dir.char)) {
            offset = dir.offset;
  ...
  mouseMove = function(e) {
    var newRegion;
    this.mouseState.x = e.layerX;
    this.mouseState.y = e.layerY;
