...
(function() {
  ...
  makeStack = function(uid, options) {
    var chunks, declarations, exitRequest, freePops, makeNext, popMethod, reads, stack, stackObj, writes, _ref, _ref1;
    if (options == null) {
      options = {};
    }
    popMethod = (_ref = options.popMethod) != null ? _ref : 'pop';
    freePops = (_ref1 = options.freePops) != null ? _ref1 : Infinity;
    stack = [];
    declarations = [];
    reads = [];
    writes = [];
