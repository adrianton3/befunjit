...
(function() {
  ...
  setupSamples = function(samples, _arg) {
    var input, select, source;
    source = _arg.source, input = _arg.input;
  ...
  setupCompilers = function(onChange) {
    ...
    ['BinaryCompiler', 'StackingCompiler', 'OptimizingCompiler', 'BasicCompiler'].forEach(function(sampleName) {
      var option;
      option = document.createElement('option');
      option.textContent = sampleName;
      select.appendChild(option);
